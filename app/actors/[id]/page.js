    ...
    <div>
      <div className="w-full px-2 ">
        <div className="card card-side bg-zinc-800 shadow-xl w-[300px] sm:w-[400px] h-full mx-auto mb-9 flex flex-col md:flex-row md:w-full md:justify-start md:items-start">
          <figure>
            <img
              src={`${tmdbimagefetchurl}${actorPersonalData.profile_path}`}
              alt="Movie"
              className="w-[100% ] md:w-[20vw] xxlg:w-[16vw] h-[100%] object-cover"
            />
          </figure>
          <div className="card-body md:w-[40%]">
            ...
            <div>
              <h2>
                <em>BirthDate: </em>
                {actorPersonalData.birthday}
              </h2>
              <h2>
                <em>Place of birth: </em>
                {actorPersonalData.place_of_birth}
              </h2>
            </div>
          </div>
        </div>
